...
imCallback = Ptr{Nothing}
imFileCounterCallback = Ptr{Nothing}
imResolutionCallback = Ptr{Nothing}
...
imGifTranspIndex = Ptr{Nothing}
imTiffImageDesc = Ptr{Nothing}
